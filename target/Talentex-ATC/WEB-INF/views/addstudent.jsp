...
<h2>${totalC}</h2>
<p>Total General Voucher Credits</p>
</div>
</div>
...
<a href="studentlist">
<h2>${usedC}</h2></a>
<a href="studentlist" style="color:#333"><p>Used General Voucher Credits</p>
</a>
</div>
</div>
...
<h2 id="balance_credits">${balanceC}</h2>

<p>Balance General Voucher Credits</p>
				...
				<div class="col-lg-12" id="addcontactperson">
                       ...
                       <div class="errormsg"></div>
						...
						<input type="text" name="voucher_type" value="1" style="display:none"/>
							</form>
								</div>
	   	        	...
	   	        	if($('#balance_credits').text() < getitem.length)
                        ...
                        $(".btn-success").attr( "disabled", "disabled" );
		   	        	  ...
		   	        	  $.ajax({
			        			url:"voucherAssign",
			        			method:"post",
			        			data:{"contactperson_json":JSON.stringify(getitem),"voucher_type":"1"},
			        		}).	done(function(){
			        			
			        				console.log("success");
			        				$(".btn-success").removeAttr( "disabled", "disabled" );
