...
<body>
	...
	<!-- Ends -->
<h1 id="vochpurchuse_status" style="display:none"><%=session.getAttribute("voucher_booked")%></h1>
...
<div class="col-lg-5">
<h3><a href="addstudent">ADD STUDENTS MANUALLY</a></h3>
...
/*  Click Event Photo Upload Start */
	...
	function phonenumber(phone) 
	{
        ...
        function createGrid(data) 
	    {
             ...
             console.log("#########################################"+data);
             if($('#balance_credits').text() < data.length){
                 ...
                 $(".sendButton").click(function(){
              	   ...
              	   $(".btn-primary").addClass("disabled");
                		$.ajax({
              			url:"voucherAssign",
              			method:"post",
              			data:{"contactperson_json":JSON.stringify(data),"voucher_type":"1"},
              		}).	done(function(){
              			    $('.form-control ').val("")
              			    $('#img_submitting').hide();
              				...
              				$(".success_status").text("Thank you for the request we shall send vouchers subject to your available credit with us");
